                ...
                >
                  ...
                  <div className="aspect-[4/3] bg-gray-200 relative">
                    <img
                      ...
                      onError={(e) => {
                        console.error(`Erreur de chargement de l'image pour l'analyse ${analyse.id}`);
                        console.error('URL tentée:', getImageUrl(analyse.id));
                        // Afficher un placeholder au lieu d'une image aléatoire
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <div className="flex gap-2 pt-2">
                      <button
                        ...
                        className="flex-1 px-4 py-2 bg-black text-white rounded-lg text-sm hover:bg-red-600 transition-colors"
                      >
                        Supprimer
                      </button>
                    </div>

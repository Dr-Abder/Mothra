            ...
            >
              {preview ? (
                <div className="relative">
                  ...
                  <button
                    onClick={handleReset}
                    className="absolute top-2 right-2 p-2 bg-black text-white rounded-full hover:bg-grey-600"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="none"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              {result && (
                <div className="space-y-6">
                  ...
                  {/* Recommendation */}
                  <div className="bg-gray-200 border border-black rounded-xl p-6">
                  ...
                  {/* Success Message */}
                  <div className="bg-gray-200 border border-black rounded-lg p-4">
